...
<template>
    <div class="relative h-full">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2
                    ...
                    Gestión de peajes</h2>
                <p class="text-[13px] text-slate-500 dark:text-slate-400 m-0">Administración y configuración de campos
                    personalizados por peaje</p>
            </div>
        ...
        <div
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-collapse">
                    ...
                    <tbody>
                        <tr v-if="cargando">
                            <td colspan="4" class="px-4 py-6 text-center text-slate-500 text-sm font-medium">Cargando
                                peajes desde la base de datos...</td>
                        </tr>
                        <tr v-else-if="peajes.length === 0">
                            <td colspan="4" class="px-4 py-8 text-center text-slate-500 text-sm">No hay peajes
        ...
        <div v-if="mostrarModal"
            class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 dark:bg-[#0a1628]/80 backdrop-blur-sm transition-opacity">
            <div
                class="w-full max-w-lg bg-white dark:bg-[#0d1b2a] rounded-2xl border border-slate-200 dark:border-white/10 shadow-2xl overflow-hidden relative">
                    ...
                    <div class="mb-6">
                        ...
                        <div v-else class="space-y-2 max-h-[160px] overflow-y-auto pr-1">
                            <div v-for="(campo, index) in nuevoPeaje.camposDinámicos" :key="index"
                                ...
                                <input v-model="campo.name" type="text" placeholder="Nombre del campo" required
