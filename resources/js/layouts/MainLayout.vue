                    ...
                    <div
                        ...
                        <div
                            ...
                            <div v-for="peaje in peajes" :key="peaje.id" @click="enfocarPeajeYcerrar(peaje.name)"
                                class="shrink-0 snap-center w-[240px] md:w-auto group relative cursor-pointer rounded-lg overflow-hidden border border-slate-200 dark:border-white/10 shadow-sm bg-slate-200 dark:bg-slate-800 aspect-video md:aspect-auto md:h-24">
